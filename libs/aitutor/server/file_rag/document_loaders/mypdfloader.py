...
from aitutor.server.file_rag.document_loaders.ocr import get_ocr
            ...
            for i, page in enumerate(doc):
                ...
                for img in img_list:
                    if xref := img.get("xref"):
                        ...
                        if (bbox[2] - bbox[0]) / (
                            page.rect.width
                        ) < Settings.kb_settings.PDF_OCR_THRESHOLD[0] or (
                            bbox[3] - bbox[1]
                        ) / (page.rect.height) < Settings.kb_settings.PDF_OCR_THRESHOLD[
                            1
                        ]:
                            continue
