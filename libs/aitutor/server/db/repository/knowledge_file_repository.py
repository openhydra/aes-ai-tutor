...
from aitutor.server.db.models.knowledge_base_model import KnowledgeBaseModel
from aitutor.server.db.models.knowledge_file_model import (
    FileDocModel,
    KnowledgeFileModel,
)
...
def add_file_to_db(
    ...
    kb = (
        ...
        .filter_by(kb_name=kb_file.kb_name, user_id=user_id)
        .first()
    )
    if kb:
