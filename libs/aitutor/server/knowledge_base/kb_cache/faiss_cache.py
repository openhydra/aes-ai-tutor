...
from aitutor.server.knowledge_base.kb_cache.base import *
from aitutor.server.knowledge_base.utils import get_vs_path
from aitutor.server.utils import get_default_embedding, get_Embeddings
        ...
        try:
            if cache is None:
                ...
                with item.acquire(msg="初始化"):
                    ...
                    vs_path = get_vs_path(user_id, kb_name, vector_name)
