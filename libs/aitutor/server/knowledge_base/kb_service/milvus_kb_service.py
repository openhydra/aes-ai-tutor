...
from aitutor.server.db.repository import list_file_num_docs_id_by_kb_name_and_file_name
...
from aitutor.server.utils import get_Embeddings
...
class MilvusKBService(KBService):
    ...
    def _load_milvus(self):
        self.milvus = Milvus(
            ...
            index_params=Settings.kb_settings.kbs_config.get("milvus_kwargs")[
                "index_params"
            ],
            search_params=Settings.kb_settings.kbs_config.get("milvus_kwargs")[
                "search_params"
            ],
            auto_id=True,
        )
...
if __name__ == "__main__":
    # 测试建表使用
    from aitutor.server.db.base import Base, engine
